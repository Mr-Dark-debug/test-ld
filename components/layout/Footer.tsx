...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary text-foreground pt-16 pb-8">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <address className="not-italic">
              ...
              <div className="flex items-center mb-4">
                ...
                <a href="tel:+919978600222" className="hover:text-[#be9e67] transition-colors">+91 9978600222</a>
              </div>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-[#be9e67]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@laxmidevelopers.com" className="hover:text-[#be9e67] transition-colors">info@laxmidevelopers.com</a>
              </div>
              <p className="flex items-center mb-2 pl-7">Sunday: Closed</p>
            </address>
          </div>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-4">
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/residential/on-going" className="text-sm hover:text-[#be9e67] transition-colors">On-Going</Link>
                  </li>
                  <li>
                    <Link href="/residential/completed" className="text-sm hover:text-[#be9e67] transition-colors">Completed</Link>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/commercial/on-going" className="text-sm hover:text-[#be9e67] transition-colors">On-Going</Link>
                  </li>
                  <li>
                    <Link href="/commercial/completed" className="text-sm hover:text-[#be9e67] transition-colors">Completed</Link>
                  </li>
                  <li>
                    <Link href="/commercial/upcoming" className="text-sm hover:text-[#be9e67] transition-colors">Upcoming</Link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="md:max-w-xs">
            ...
            <p className="mb-4">Stay updated with our latest projects and offers.</p>
            <form className="space-y-3">
              ...
              <button 
                type="submit" 
                className="w-full px-4 py-2 bg-highlight text-primary font-medium rounded-md hover:bg-highlight/90 transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-16 border-t border-border pt-8 flex flex-col items-center">
          <div className="flex space-x-6 mb-6">
            <div className="flex items-center justify-center border border-border rounded-full w-16 h-16">
          ...
          <div className="text-center text-foreground/70">
            ...
            <p>&copy; {currentYear} Laxmi Developers. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
