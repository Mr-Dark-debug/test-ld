        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <address className="not-italic text-gray-300">
              ...
              <div className="flex items-center mb-4">
                ...
                <a href="tel:+919978600222" className="text-gray-300 hover:text-white transition-colors">+91 9978600222</a>
              </div>
              <div className="flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href="mailto:info@laxmidevelopers.com" className="text-gray-300 hover:text-white transition-colors">info@laxmidevelopers.com</a>
              </div>
          ...
          <div className="mb-8 md:mb-0">
            ...
            <ul className="space-y-4 text-gray-300">
              ...
              <li>
                <Link href="/why-laxmi" className="hover:text-white transition-colors">Why Laxmi?</Link>
              </li>
              <li>
            ...
            <div className="grid grid-cols-2 gap-x-4 gap-y-4">
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/residential/on-going" className="text-sm text-gray-300 hover:text-white transition-colors">On-Going</Link>
                  </li>
                  <li>
                    <Link href="/residential/completed" className="text-sm text-gray-300 hover:text-white transition-colors">Completed</Link>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <Link href="/commercial/on-going" className="text-sm text-gray-300 hover:text-white transition-colors">On-Going</Link>
                  </li>
                  <li>
                    <Link href="/commercial/completed" className="text-sm text-gray-300 hover:text-white transition-colors">Completed</Link>
                  </li>
                  <li>
                    <Link href="/commercial/upcoming" className="text-sm text-gray-300 hover:text-white transition-colors">Upcoming</Link>
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="md:max-w-xs">
            ...
            <form className="space-y-3">
              ...
              <button 
                type="submit" 
                className="w-full px-4 py-2 bg-[#334390] text-white font-medium rounded-md hover:bg-[#334390]/90 transition-colors"
              >
                Subscribe
              </button>
            </form>
