        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {brochureUrl && (
                <Button href={brochureUrl} variant="default">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="mt-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
              {amenities.map((amenity) => (
                <div
                  key={amenity.id}
                  className="bg-card p-4 rounded-lg shadow-md flex flex-col items-center text-center"
                >
                  <div className="text-highlight mb-3 h-12 w-12 flex items-center justify-center">
                    {amenity.icon}
                  </div>
                  <h3 className="text-base font-medium">{amenity.name}</h3>
                </div>
              ))}
            </div>
          </div>
